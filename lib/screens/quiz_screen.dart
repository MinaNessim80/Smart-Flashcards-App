...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (arguments is Map<String, dynamic> && arguments['reuseQuestions'] == true) {
      
      categoryQuestions = arguments['questions'] as List<Question>;
      setState(() {
    ...
    final category = arguments is String ? arguments : null;
